 ...
 */
final class Version20240214174117 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE offre CHANGE datereservation startdate VARCHAR(255) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE offre CHANGE startdate datereservation VARCHAR(255) DEFAULT NULL');
    }
}
